...
class CmsSeeder extends Seeder
{
    ...
    {
        foreach ([
            ['about', 'Biz haqimizda', 'О нас', 'About us', "<p><strong>Textile</strong> — Turkiya va Xitoydan keltirilgan sifatli, logosiz kiyimlar. Siz 3D konstruktorda o'z logotipingiz yoki yozuvingizni qo'yasiz, biz bosamiz, tikamiz va yetkazib beramiz.</p><p>Har bir buyurtma alohida tayyorlanadi: 1 donadan boshlab, korporativ buyurtmalar uchun chegirmalar.</p>", '<p><strong>Textile</strong> — качественная одежда без логотипов из Турции и Китая. Вы добавляете свой логотип или надпись в 3D-конструкторе, мы печатаем, шьём и доставляем.</p>', '<p><strong>Textile</strong> — quality blank apparel from Turkey and China. Add your logo or text in the 3D designer, we print, sew and deliver.</p>'],
        ...
        if (Banner::query()->doesntExist()) {
            Banner::query()->create(['title_uz' => 'Sifatli kiyim. Sizning logotipingiz.', 'title_ru' => 'Качественная одежда. Ваш логотип.', 'title_en' => 'Quality apparel. Your logo.', 'subtitle_uz' => "Turkiya va Xitoydan keltirilgan logosiz kiyimlarga o'z logotipingiz yoki yozuvingizni qo'ying, 3D da aylantirib ko'ring, razmer tanlang — biz tikib yetkazamiz.", 'subtitle_ru' => 'Добавьте свой логотип или надпись, посмотрите в 3D, выберите размер — мы сошьём и доставим.', 'subtitle_en' => 'Add your logo or text, preview in 3D, pick a size — we sew and deliver.', 'button_text_uz' => 'Dizayn qilishni boshlash', 'button_text_ru' => 'Начать дизайн', 'button_text_en' => 'Start designing', 'link' => '/studio', 'sort' => 0]);
            Banner::query()->create(['title_uz' => 'Tayyor brendli dizaynlar', 'title_ru' => 'Готовые брендовые дизайны', 'title_en' => 'Ready-made branded designs', 'subtitle_uz' => 'Sevimli klubingiz yoki brendingiz logosi bilan — bir bosishda konstruktorda ochiladi.', 'subtitle_ru' => 'С логотипом любимого клуба или бренда — открывается в конструкторе одним кликом.', 'subtitle_en' => 'With your favourite club or brand logo — opens in the designer in one click.', 'button_text_uz' => 'Tayyor dizaynlar', 'button_text_ru' => 'Готовые дизайны', 'button_text_en' => 'Ready designs', 'link' => '/#templates', 'sort' => 1]);
        }
